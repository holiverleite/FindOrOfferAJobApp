//
//  ProfessionOptionsViewController.swift
//  FindOrOfferAJobApp
//
...
protocol ProfessionSelectedDelegate: class {
    func professionSelected(profession: String)
}

class ProfessionOptionsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = String.localize("select_one_profession_nav_bar")
...
extension ProfessionOptionsViewController: UITableViewDelegate, UITableViewDataSource {
